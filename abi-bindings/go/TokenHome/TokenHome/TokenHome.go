...
// TokenHomeFromCosmosTokensSentIterator is returned from FilterFromCosmosTokensSent and is used to iterate over the raw logs and unpacked data for FromCosmosTokensSent events raised by the TokenHome contract.
type TokenHomeFromCosmosTokensSentIterator struct {
	Event *TokenHomeFromCosmosTokensSent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenHomeFromCosmosTokensSentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenHomeFromCosmosTokensSent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenHomeFromCosmosTokensSentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenHomeFromCosmosTokensSentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenHomeFromCosmosTokensSent represents a FromCosmosTokensSent event raised by the TokenHome contract.
type TokenHomeFromCosmosTokensSent struct {
...
func (_TokenHome *TokenHomeFilterer) FilterFromCosmosTokensSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, sender []common.Address) (*TokenHomeFromCosmosTokensSentIterator, error) {
	...
	logs, sub, err := _TokenHome.contract.FilterLogs(opts, "FromCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return &TokenHomeFromCosmosTokensSentIterator{contract: _TokenHome.contract, event: "FromCosmosTokensSent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event FromCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,bytes32,address,bytes32,bytes,address,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenHome *TokenHomeFilterer) WatchFromCosmosTokensSent(opts *bind.WatchOpts, sink chan<- *TokenHomeFromCosmosTokensSent, teleporterMessageID [][32]byte, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenHome.contract.WatchLogs(opts, "FromCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenHomeFromCosmosTokensSent)
				if err := _TokenHome.contract.UnpackLog(event, "FromCosmosTokensSent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event FromCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,bytes32,address,bytes32,bytes,address,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenHome *TokenHomeFilterer) ParseFromCosmosTokensSent(log types.Log) (*TokenHomeFromCosmosTokensSent, error) {
	event := new(TokenHomeFromCosmosTokensSent)
	if err := _TokenHome.contract.UnpackLog(event, "FromCosmosTokensSent", log); err != nil {
		return nil, err
	}
...
// TokenHomeToCosmosTokensSentIterator is returned from FilterToCosmosTokensSent and is used to iterate over the raw logs and unpacked data for ToCosmosTokensSent events raised by the TokenHome contract.
type TokenHomeToCosmosTokensSentIterator struct {
	Event *TokenHomeToCosmosTokensSent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenHomeToCosmosTokensSentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenHomeToCosmosTokensSent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenHomeToCosmosTokensSentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenHomeToCosmosTokensSentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenHomeToCosmosTokensSent represents a ToCosmosTokensSent event raised by the TokenHome contract.
type TokenHomeToCosmosTokensSent struct {
	TeleporterMessageID [32]byte
	Sender              common.Address
...
func (_TokenHome *TokenHomeFilterer) FilterToCosmosTokensSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, sender []common.Address) (*TokenHomeToCosmosTokensSentIterator, error) {
	...
	logs, sub, err := _TokenHome.contract.FilterLogs(opts, "ToCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return &TokenHomeToCosmosTokensSentIterator{contract: _TokenHome.contract, event: "ToCosmosTokensSent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ToCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,address,bytes,bytes32,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenHome *TokenHomeFilterer) WatchToCosmosTokensSent(opts *bind.WatchOpts, sink chan<- *TokenHomeToCosmosTokensSent, teleporterMessageID [][32]byte, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenHome.contract.WatchLogs(opts, "ToCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenHomeToCosmosTokensSent)
				if err := _TokenHome.contract.UnpackLog(event, "ToCosmosTokensSent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ToCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,address,bytes,bytes32,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenHome *TokenHomeFilterer) ParseToCosmosTokensSent(log types.Log) (*TokenHomeToCosmosTokensSent, error) {
	event := new(TokenHomeToCosmosTokensSent)
	if err := _TokenHome.contract.UnpackLog(event, "ToCosmosTokensSent", log); err != nil {
		return nil, err
	}
...
// TokenHomeTokensCosmosWithdrawnIterator is returned from FilterTokensCosmosWithdrawn and is used to iterate over the raw logs and unpacked data for TokensCosmosWithdrawn events raised by the TokenHome contract.
type TokenHomeTokensCosmosWithdrawnIterator struct {
	Event *TokenHomeTokensCosmosWithdrawn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenHomeTokensCosmosWithdrawnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenHomeTokensCosmosWithdrawn)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenHomeTokensCosmosWithdrawnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenHomeTokensCosmosWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenHomeTokensCosmosWithdrawn represents a TokensCosmosWithdrawn event raised by the TokenHome contract.
type TokenHomeTokensCosmosWithdrawn struct {
	MessageID [32]byte
	Recipient common.Address
	Amount    *big.Int
	Raw       types.Log // Blockchain specific contextual infos
...
func (_TokenHome *TokenHomeFilterer) FilterTokensCosmosWithdrawn(opts *bind.FilterOpts, recipient []common.Address) (*TokenHomeTokensCosmosWithdrawnIterator, error) {
	...
	logs, sub, err := _TokenHome.contract.FilterLogs(opts, "TokensCosmosWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return &TokenHomeTokensCosmosWithdrawnIterator{contract: _TokenHome.contract, event: "TokensCosmosWithdrawn", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokensCosmosWithdrawn(bytes32 messageID, address indexed recipient, uint256 amount)
func (_TokenHome *TokenHomeFilterer) WatchTokensCosmosWithdrawn(opts *bind.WatchOpts, sink chan<- *TokenHomeTokensCosmosWithdrawn, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenHome.contract.WatchLogs(opts, "TokensCosmosWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenHomeTokensCosmosWithdrawn)
				if err := _TokenHome.contract.UnpackLog(event, "TokensCosmosWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TokensCosmosWithdrawn(bytes32 messageID, address indexed recipient, uint256 amount)
func (_TokenHome *TokenHomeFilterer) ParseTokensCosmosWithdrawn(log types.Log) (*TokenHomeTokensCosmosWithdrawn, error) {
	event := new(TokenHomeTokensCosmosWithdrawn)
	if err := _TokenHome.contract.UnpackLog(event, "TokensCosmosWithdrawn", log); err != nil {
		return nil, err
	}
