...
// TokenRemoteFromCosmosTokensSentIterator is returned from FilterFromCosmosTokensSent and is used to iterate over the raw logs and unpacked data for FromCosmosTokensSent events raised by the TokenRemote contract.
type TokenRemoteFromCosmosTokensSentIterator struct {
	Event *TokenRemoteFromCosmosTokensSent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenRemoteFromCosmosTokensSentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenRemoteFromCosmosTokensSent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenRemoteFromCosmosTokensSentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenRemoteFromCosmosTokensSentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenRemoteFromCosmosTokensSent represents a FromCosmosTokensSent event raised by the TokenRemote contract.
type TokenRemoteFromCosmosTokensSent struct {
...
func (_TokenRemote *TokenRemoteFilterer) FilterFromCosmosTokensSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, sender []common.Address) (*TokenRemoteFromCosmosTokensSentIterator, error) {
	...
	logs, sub, err := _TokenRemote.contract.FilterLogs(opts, "FromCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return &TokenRemoteFromCosmosTokensSentIterator{contract: _TokenRemote.contract, event: "FromCosmosTokensSent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event FromCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,bytes32,address,bytes32,bytes,address,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) WatchFromCosmosTokensSent(opts *bind.WatchOpts, sink chan<- *TokenRemoteFromCosmosTokensSent, teleporterMessageID [][32]byte, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenRemote.contract.WatchLogs(opts, "FromCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenRemoteFromCosmosTokensSent)
				if err := _TokenRemote.contract.UnpackLog(event, "FromCosmosTokensSent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event FromCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,bytes32,address,bytes32,bytes,address,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) ParseFromCosmosTokensSent(log types.Log) (*TokenRemoteFromCosmosTokensSent, error) {
	event := new(TokenRemoteFromCosmosTokensSent)
	if err := _TokenRemote.contract.UnpackLog(event, "FromCosmosTokensSent", log); err != nil {
		return nil, err
	}
...
// TokenRemoteToCosmosTokensSentIterator is returned from FilterToCosmosTokensSent and is used to iterate over the raw logs and unpacked data for ToCosmosTokensSent events raised by the TokenRemote contract.
type TokenRemoteToCosmosTokensSentIterator struct {
	Event *TokenRemoteToCosmosTokensSent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenRemoteToCosmosTokensSentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenRemoteToCosmosTokensSent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenRemoteToCosmosTokensSentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenRemoteToCosmosTokensSentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenRemoteToCosmosTokensSent represents a ToCosmosTokensSent event raised by the TokenRemote contract.
type TokenRemoteToCosmosTokensSent struct {
	TeleporterMessageID [32]byte
	Sender              common.Address
...
func (_TokenRemote *TokenRemoteFilterer) FilterToCosmosTokensSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, sender []common.Address) (*TokenRemoteToCosmosTokensSentIterator, error) {
	...
	logs, sub, err := _TokenRemote.contract.FilterLogs(opts, "ToCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return &TokenRemoteToCosmosTokensSentIterator{contract: _TokenRemote.contract, event: "ToCosmosTokensSent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ToCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,address,bytes,bytes32,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) WatchToCosmosTokensSent(opts *bind.WatchOpts, sink chan<- *TokenRemoteToCosmosTokensSent, teleporterMessageID [][32]byte, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenRemote.contract.WatchLogs(opts, "ToCosmosTokensSent", teleporterMessageIDRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenRemoteToCosmosTokensSent)
				if err := _TokenRemote.contract.UnpackLog(event, "ToCosmosTokensSent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ToCosmosTokensSent(bytes32 indexed teleporterMessageID, address indexed sender, (bytes32,address,bytes,bytes32,address,uint256,uint256,uint256,address) input, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) ParseToCosmosTokensSent(log types.Log) (*TokenRemoteToCosmosTokensSent, error) {
	event := new(TokenRemoteToCosmosTokensSent)
	if err := _TokenRemote.contract.UnpackLog(event, "ToCosmosTokensSent", log); err != nil {
		return nil, err
	}
...
// TokenRemoteTokensCosmosWithdrawnIterator is returned from FilterTokensCosmosWithdrawn and is used to iterate over the raw logs and unpacked data for TokensCosmosWithdrawn events raised by the TokenRemote contract.
type TokenRemoteTokensCosmosWithdrawnIterator struct {
	Event *TokenRemoteTokensCosmosWithdrawn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenRemoteTokensCosmosWithdrawnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenRemoteTokensCosmosWithdrawn)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenRemoteTokensCosmosWithdrawnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenRemoteTokensCosmosWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenRemoteTokensCosmosWithdrawn represents a TokensCosmosWithdrawn event raised by the TokenRemote contract.
type TokenRemoteTokensCosmosWithdrawn struct {
	MessageID [32]byte
	Recipient common.Address
	Amount    *big.Int
	Raw       types.Log // Blockchain specific contextual infos
...
func (_TokenRemote *TokenRemoteFilterer) FilterTokensCosmosWithdrawn(opts *bind.FilterOpts, recipient []common.Address) (*TokenRemoteTokensCosmosWithdrawnIterator, error) {
	...
	logs, sub, err := _TokenRemote.contract.FilterLogs(opts, "TokensCosmosWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return &TokenRemoteTokensCosmosWithdrawnIterator{contract: _TokenRemote.contract, event: "TokensCosmosWithdrawn", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokensCosmosWithdrawn(bytes32 messageID, address indexed recipient, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) WatchTokensCosmosWithdrawn(opts *bind.WatchOpts, sink chan<- *TokenRemoteTokensCosmosWithdrawn, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TokenRemote.contract.WatchLogs(opts, "TokensCosmosWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenRemoteTokensCosmosWithdrawn)
				if err := _TokenRemote.contract.UnpackLog(event, "TokensCosmosWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TokensCosmosWithdrawn(bytes32 messageID, address indexed recipient, uint256 amount)
func (_TokenRemote *TokenRemoteFilterer) ParseTokensCosmosWithdrawn(log types.Log) (*TokenRemoteTokensCosmosWithdrawn, error) {
	event := new(TokenRemoteTokensCosmosWithdrawn)
	if err := _TokenRemote.contract.UnpackLog(event, "TokensCosmosWithdrawn", log); err != nil {
		return nil, err
	}
