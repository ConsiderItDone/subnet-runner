...
SUBNET_ID="GEieSy2doZ96bpMo5CuHPaX1LvaxpKZ9C72L22j94t6YyUb6X"
...
# Run the icm-relayer command with the specified configuration file
icm-relayer --config-file $AWM_CONFIG_FILE
